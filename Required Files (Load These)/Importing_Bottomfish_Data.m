...
vue_filename = '/Users/stephenscherrer/Dropbox/Lab Folder/Oahu Receiver Data Files/VUE_Export_2014-Oct-8.csv';
...
Date=(datenum(2012,08,18,17,31,00)-min(datenum(TaggingDateandTimeUTC)))+datenum(TaggingDateandTimeUTC);
