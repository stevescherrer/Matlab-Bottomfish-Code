...
BottomFish=[BottomFish,Sex, Mass, Length];
...
MeanLengthIn=sum(IndividualsIn(:,10))/length(IndividualsIn);
MeanLengthOut=sum(IndividualsOut(:,10))/length(IndividualsOut);
