...
[DistanceFromString1,~]=lldistkm([LatOfTagString1,LonOfTagString1],[LatOfReceiverString,LonOfReceiverString])*1000; %%lldistkm gives distance between 2 lat and lon points as km, multiplied by 1000 to get distance in meters, downloaded 24 feb 2014 from http://www.mathworks.com/matlabcentral/fileexchange/38812-latlon-distance
[DistanceFromString2,~]=lldistkm([LatOfTagString2,LonOfTagString2],[LatOfReceiverString,LonOfReceiverString])*1000;
...
csvwrite('RangeTestDataToFitInLoggerPro.csv',AllDetectionRatesByDay);
